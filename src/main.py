...
def main():
    ...
    print(f"[CONFIG] Loaded configuration (Late Entry V3 + Hybrid Stop-Loss)")
    print(f"         Entry Window: Last {config['strategy']['entry_window_sec']} seconds")
    ...
    print(f"         Sizing: 8/10/12 contracts (time-based)")
    print()
...
<i>Wallet: {order_executor.wallet_address[:6]}...{order_executor.wallet_address[-4:]}</i>"""
    ...
    # Final summary
    print("\n" + "=" * 115)
    print("  FINAL RESULTS - MULTI-MARKET TRADING".center(115))
    print("=" * 115)
